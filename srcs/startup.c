...
t_hmac_hash_interface	g_hi_sha_1;
...
bool	on_startup(void) {
	...
	g_hi_sha_1     = (t_hmac_hash_interface)x_make_hmac_interface(&g_hash_sha_1);
	...
	g_prf_hmac_sha_1       = (t_pbkdf2_prf)make_prf(hmac_sha_1, &g_hi_sha_1);
